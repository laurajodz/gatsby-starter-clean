      ...
      <div>
       ...
       https://gist.github.com/fool/b0f254ff8c72a5765b6a9138249789d6" target="_blank">{"list"}</a></h3>
        ...
        <h3>{"Why do you think SSL/HTTPS is important"}</h3>
          ...
          <p>{"According to the Netlify documentation, there are 5 advantages to using HTTPS:"}</p>
          <ol>
        ...
        <h3>{"Explain, in a couple of paragraphs, what you think 2 major challenges around DNS configuration are for less-technical internet end-users"}</h3>
          <p>{"I set up DNS for my portfolio web site and the major challenge was… everything. I was lost from the beginning. I don't have DNS experience, and less-technical end-uesrs certainly do not. I assumed my domain provider would provide easy follow along steps. They certainly did when it came to purchasing the domain. But the instructions were awful, especially for someone doing this for the first time. There are lots of steps, but no logical step-by-step is provided."}</p>
          <p>{"The main challenges are that the process is too convuluted and that the language is too technical. The end user needs step-by-step instructions that are easy to understand to do the configuration on their own."}</p>
